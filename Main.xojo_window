...
Begin Window Main
   ...
   Begin PagePanel PagePanel1
      ...
      Begin Label Label17
         ...
         TabPanelIndex   =   4
         TabStop         =   False
         Text            =   "Use Cryptoaddik to keep your Coins/Tokens completely offline."
         TextAlign       =   0
         TextColor       =   &c3A77B300
         TextFont        =   "System"
         TextSize        =   24.0
   ...
   Begin Label LabelVersion
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Check for latest release of Cryptoaddik"
      TextAlign       =   0
      TextColor       =   &c3A77B300
      TextFont        =   "System"
      TextSize        =   13.0
...
#tag WindowCode
	...
	#tag Event
		Sub Open()
		  ...
		  cmd = "tasklist | find /I /C ""Cryptoaddik.exe"""
		  ...
		  If Trunning > 1 Then
		    MsgBox("Cryptoaddik is already running! Can not run multiple instances of Cryptoaddik")
		    Main.Close
		    Fermer.Show
		    Exit
		  End if
		  ...
		  If socket1.IsConnected Then
		    ...
		    Vparam = Sock.Get("http://addik.co/ver.txt",10)
		    if Val(Vparam) > Val(App.ShortVersion) then
		      app.INTisConnected = True
		      LabelVersion.text = "A new Cryptoaddik version " + Vparam + " is available now"
		    End if
		  Else
...
#tag Events SupPic3
	#tag Event
		Function MouseDown(X As Integer, Y As Integer) As Boolean
		  ...
		  ShowURL("https://github.com/Cryptoaddik/Cryptoaddik")
		End Function
	#tag EndEvent
	#tag Event
		Sub MouseExit()
...
#tag Events SupPic5
	#tag Event
		Function MouseDown(X As Integer, Y As Integer) As Boolean
		  ...
		  ShowURL("mailto:support@addik.co")
		End Function
	#tag EndEvent
	#tag Event
		Sub MouseExit()
...
#tag Events SupPic6
	#tag Event
		Function MouseDown(X As Integer, Y As Integer) As Boolean
		  ...
		  ShowURL("https://github.com/Cryptoaddik/Cryptoaddik/wiki")
		End Function
	#tag EndEvent
	#tag Event
		Sub MouseExit()
...
#tag Events LabelVersion
	...
	#tag Event
		Function MouseDown(X As Integer, Y As Integer) As Boolean
		  ...
		  ShowURL "https://github.com/Cryptoaddik/Cryptoaddik/releases"
		End Function
	#tag EndEvent
#tag EndEvents
#tag Events Timer1
