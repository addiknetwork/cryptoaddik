...
#tag Events Timer1
	#tag Event
		Sub Action()
		  ...
		  dim fi as FolderItem = SpecialFolder.ApplicationData.Child("Cryptoaddik")
		  ...
		  dest=SpecialFolder.ApplicationData.Child("Cryptoaddik/wallet.dat")
